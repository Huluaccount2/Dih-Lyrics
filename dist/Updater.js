...
class Updater {
    ...
    static forceUpdate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Downloads the zip archive from Huluaccount2/Dih-Lyrics (v3 branch)
            yield Updater.downloadRepo("Huluaccount2", "Dih-Lyrics", "v3", downloadPath);
            // Replaces files pointing to the correct extracted folder structure: Dih-Lyrics-v3
            Updater.replaceFiles((0, path_1.join)(downloadPath, "./Dih-Lyrics-v3"), (0, path_1.join)(__dirname, "../"), exclude);
        });
    }
    static checkUpdate() {
        return __awaiter(this, void 0, void 0, function* () {
            // Checks your fork's raw VERSION file on the v3 branch for changes
            const version = yield (yield fetch("https://github.com/Huluaccount2/Dih-Lyrics/raw/refs/heads/v3/VERSION")).text();
